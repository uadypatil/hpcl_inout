...
if (isset($_POST['submit'])) {
     ...
     for ($x = $token_no + 1; $x <= $total; $x++) {
          $sql2 = "INSERT INTO tat(token_no) VALUES ('$x')";
...
<body>
               ...
               <div class="container-fluid">
                    ...
                    <div class="container-fluid">
                         ...
                         <div class="counter-div">
                              ...
                              <form action="<?php // htmlspecialchars($_Server['PHP_SELF']); ?>" id="tatForm" method="post">
                                   <div class="row">
                                        <div class="col-lg-5">
                                             <label for="" class="fs-3">TAT Cylinder Count</label>
                                        </div>
                                        <div class="col-lg-7">
                                   ...
                                   <div id="officerForm" class="row"> 
                                        ...
                                        <div class="col-lg-5">
                                             <input type="text" name="addtoken"
                                                  ...
                                                  minlength="2" maxlength="2" id="tatInput" class="form-control">
                                             <!-- addcard -->
                                        </div>
                                        <!-- change button -->
                                        <div class="col-lg-7">
                                                  ...
                                                  <div class="card text-center" id="<?php echo $uniqueCardId ?>">
                                                       ...
                                                       <div class="card-body">
                                                            ...
                                                            if ($name) { // If name exists in the database
                                                                 ?>
                                                                 <a href="edittat.php?token=<?php echo $row1['token_no'] ?>"
                                                                      class="btn btn-primary form-control">
                                                                      <i class="fa-solid fa-edit"></i>Edit</a>
                                                            <?php } else { // If name doesn't exist in the database ?>
                                                                 <a href="addtat.php?token=<?php echo $row1['token_no'] ?>"
                                                                      class="btn btn-primary form-control">
     ...
     <script>
          ...
          document.getElementById('navbar-title').innerHTML = "TAT <i class='fa-solid fa-users'></i>";
     </script>
     ...
     <script>
        document.getElementById('tatForm').addEventListener('submit', function (e) {
            var inputField = document.getElementById('tatInput');
