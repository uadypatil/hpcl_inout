...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_num_rows($resa) > 0) {
        ...
        //  </script>';
         ...
         $sqlof = "INSERT INTO `uni_aadhar` (`aadhar_no`, `role`) VALUES ('$aadhar_no', 'EMP')";
         $resof = mysqli_query($connection, $sqlof); 
 

   $sql = "UPDATE `employee` SET `aadhar_no`='$aadhar_no',`full_name`='$full_name',`mobile_no`='$mobile_no',`address`='$address' WHERE `token_no` = '$token'";
...
<body>
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-4">
                                    ...
                                    <input type="text" name="full_name" id="full_name"
                                        oninput="this.value=this.value.replace(/[^a-z\sA-Z]/g,'');ws(this.id);ws(this.id);" class="form-control"
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-4">
                                    ...
                                    <textarea name="address" id="address" class="form-control"
                                        oninput="this.value=this.value.replace(/[^a-z\sA-Z0-9,.-]/g,'');ws(this.id);" rows="3"
    ...
    <script>
        ...
        document.getElementById("navbar-title").innerHTML = "Add Employee Form <i class='fa-solid fa-users'></i>";
    </script>
