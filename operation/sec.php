...
if (isset($_POST['submit'])) {
     ...
     for ($x = $token_no + 1; $x <= $total; $x++) {
          $sql2 = "INSERT INTO sec(token_no) VALUES ('$x')";
...
<body>
               ...
               <div class="container-fluid">
                    ...
                    <div class="container-fluid">
                         ...
                         <div class="counter-div">
                              ...
                              <form action="<?php // htmlspecialchars($_Server['PHP_SELF']); ?>" id="secForm" method="post">
                                   <div class="row">
                                        <div class="col-lg-5">
                                             <label for="" class="fs-3">SEC Cylinder Count</label>
                                        </div>
                                        <div class="col-lg-7">
                                   ...
                                   <div id="officerForm" class="row">
                                        ...
                                        <div class="col-lg-5">
                                             <input type="text" name="addtoken"
                                                  ...
                                                  minlength="2" maxlength="2" id="secInput" class="form-control">
                                             <!-- addcard -->
                                        </div>
                                        <!-- change button -->
                                        <div class="col-lg-7">
                                                  ...
                                                  <div class="card text-center" id="<?php echo $uniqueCardId ?>">
                                                       ...
                                                       <div class="card-body">
                                                            ...
                                                            if ($name) { // If name exists in the database
                                                                 ?>
                                                                 <a href="editsec.php?token=<?php echo $row1['token_no'] ?>"
                                                                      class="btn btn-primary form-control">
                                                                      <i class="fa-solid fa-edit"></i>Edit</a>
                                                            <?php } else { // If name doesn't exist in the database ?>
                                                                 <a href="addsec.php?token=<?php echo $row1['token_no'] ?>"
                                                                      class="btn btn-primary form-control">
     ...
     <script>
          ...
          document.getElementById('navbar-title').innerHTML = "SEC <i class='fa-solid fa-users'></i>";
     </script>
     ...
     <script>
        document.getElementById('secForm').addEventListener('submit', function (e) {
            var inputField = document.getElementById('secInput');
