...
if (isset($_POST['submit'])) {
     ...
     for ($x = $token_no + 1; $x <= $total; $x++) {
          $sql2 = "INSERT INTO contractor(token_no) VALUES ('$x')";
...
<body>
               ...
               <div class="container-fluid">
                    ...
                    <div class="container-fluid">
                         ...
                         <div class="counter-div">
                              ...
                              <form action="<?php // htmlspecialchars($_Server['PHP_SELF']); ?>" id="contractorForm" method="post">
                                   <div class="row">
                                        <div class="col-lg-4">
                                             <label class="fs-3">Contractor Cylinder Count</label>
                                        </div>
                                        <div class="col-lg-9">
                                   ...
                                   <div id="officerForm" class="row">
                                        ...
                                        <div class="col-lg-5">
                                             ...
                                             maxlength="2" id="contractorInput" class="form-control">
                                             <!-- addcard -->
                                        </div>
                                        <!-- change button -->
                                        <div class="col-lg-7">
     ...
     <script>
          ...
          document.getElementById('navbar-title').innerHTML = "Contractor <i class='fa-solid fa-users'></i>";
     </script>
     ...
     <script>
        ...
        document.getElementById('contractorForm').addEventListener('submit', function (e) {
            var inputField = document.getElementById('contractorInput');
