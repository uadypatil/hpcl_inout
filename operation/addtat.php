...
if (isset($_POST['submit'])) {
    ...
    if(mysqli_num_rows($resa) > 0) {
     ...
     //    </script>';
        ...
        $sqlof = "INSERT INTO `uni_aadhar` (`aadhar_no`, `role`) VALUES ('$aadhar_no', 'TAT')";
     ...
     // $sql = "INSERT INTO `tat`(`token_no`, `aadhar_no`,`full_name`,`mobile_no`,`address`) values('$token_no', '$aadhar_no','$full_name','$mobile_no','$address')";
     $sql = "UPDATE `tat` SET `aadhar_no`='$aadhar_no' ,`full_name`='$full_name' ,`mobile_no`='$mobile_no' ,`address`='$address' WHERE `token_no` = '$token_no'";
...
<body>
                              ...
                              <form method="post" id="myform" action="<?php htmlspecialchars($_SERVER['PHP_SELF']) ?>" enctype="multipart/form-data">
                                   ...
                                   <div class="btn">
                                        <button class="btn btn-primary" name="submit"><i
                                             ...
                                             Save</button>
                                        <!-- <button class="btn btn-secondary" name="submit"><i
     ...
     <script>
          ...
          document.getElementById('navbar-title').innerHTML = "Add TAT Form";
     </script>
