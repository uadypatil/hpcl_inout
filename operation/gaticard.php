...
if (isset($_GET['token'])) {
     ...
     $filename = "";
     $qr_code = "";
     $sql_icard = "SELECT `full_name`, `mobile_no`, `address`,`working_as` ,`qr_code`, `qr_path` FROM `gat` WHERE `token_no` = '$token'";
     ...
     if ($res_icard) {
          ...
          <body>
               ...
               <script>
                    ...
                    document.getElementById('navbar-title').innerHTML = "Gat I-Card";               
               </script>
