...
$sql = "SELECT * from gat where token_no=$token";
...
if(isset($_GET['token'])){
    ...
    if(mysqli_num_rows($resa) > 0){
       ...
       $sqlo = "SELECT * FROM gat where aadhar_no= '$aadhar_no'";
...
if (isset($_POST['drop'])) {
    ...
    $sql = "UPDATE `gat` SET `aadhar_no`=NULL,`full_name`=NULL,`mobile_no`=NULL,`address`=NULL,`qr_code`=NULL, `qr_path`=NULL,`restricted` = '0' WHERE `id`='$token'";
...
function isQrGenerated($token_no)
{
    ...
    $sql = "SELECT `qr_code` FROM `gat` WHERE `token_no` = $token_no";
    global $connection;
    $res = mysqli_query($connection, $sql);
    if ($res) {
...
{
    global $connection;
    $sql = "SELECT `id`, `token_no`, `working_as` FROM `gat` WHERE `token_no` = '$token_no'";
    $res = mysqli_query($connection, $sql);
    $working_as = "";
    ...
    $sqlUpdate = "UPDATE `gat` SET `qr_code`='$finalQr' ,`qr_path`='$filename'  WHERE `token_no` = '$token_no'";
...
{
    header("Location: gaticard.php?token=$token_no");
}
...
$sql = "SELECT * from `gat` where `token_no`= " . $_GET['token'];
$res = mysqli_query($connection, $sql);
$row = mysqli_fetch_assoc($res);
...
<body>
                        ...
                        <form method="post" id="myform" action="<?php htmlspecialchars($_SERVER['PHP_SELF']) ?>"
                            ...
                            <div class="row mt-2">
                                <div class="col-md-12 mb-4">
                                    ...
                                    <input type="text" id="token_no" name="token_no"
                                        value="<?php echo $row['token_no']; ?> " class="form-control"
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-4">
                                    ...
                                    <input type="text" name="aadhar_no" id="aadhar_no"
                                        ...
                                        maxlength="12" id="aadhar_no" class="form-control"
                                        value="<?php echo $row['aadhar_no']; ?>" placeholder="Enter Aadhar Number"
                                        onchange="validateIdcard()" required>
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-4">
                                    ...
                                    <input type="text" name="mobile_no" id="mobile_no" class="form-control"
                                        ...
                                        maxlength="10" value="<?php echo $row['mobile_no']; ?>"
                                        placeholder="Enter Mobile Number" onchange="validateIdcard()" required>
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-4">
                                    ...
                                    <textarea name="address" id="address" class="form-control" rows="3" oninput="this.value=this.value.replace(/[^a-z\sA-Z0-9,.-]/g,'');ws(this.id);" placeholder="Enter Address"
                                        onchange="validateIdcard()" required><?php echo $row['address']; ?></textarea>
                                ...
                                <div class="ms-3 ">
                                    ...
                                    <!-- <a href="<?php // echo "gaticard.php?token=" . $_GET['token']; ?>"
    ...
    <script>
        ...
        document.getElementById('navbar-title').innerHTML = "Edit GAT Form";
    </script>
