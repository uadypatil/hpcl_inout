...
$sql1 = "SELECT * FROM contractor_workman";
...
if (isset($_POST['submit'])) {
     ...
     for ($x = $token_no + 1; $x <= $total; $x++) {
          $sql2 = "INSERT INTO contractor_workman(token_no) VALUES ('$x')";
...
<body>
               ...
               <div class="container-fluid">
                    ...
                    <div class="container-fluid">
                         ...
                         <div class="counter-div">
                              ...
                              <form action="<?php // htmlspecialchars($_Server['PHP_SELF']); ?>" id="contractor_workmanForm" method="post">
                                   <div class="row">
                                        <div class="col-lg-5">
                                             <label for="" class="fs-3">Contractor Workman Cylinder Count</label>
                                        </div>
                                        <div class="col-lg-7">
                                   ...
                                   <div id="contractor_workmanform" class="row">
                                        ...
                                        <div class="col-lg-7">
                                             ...
                                             <i class="fa-solid fa-plus"></i>
                                                  <span>Add Contractor Workman</span>
                                             </button>
                                        </div>
                                   </div>
                              </form>
                                        ...
                                        <?php while ($row1 = mysqli_fetch_assoc($res1)) {
                                             ...
                                             <div class="col-12 col-sm-6 col-md-3 col-lg-2 mb-5">
                                                  <div class="card text-center" id="<?php echo $uniqueCardId ?>">
                                                       <div class="error-box w-100 d-block text-start">
                                                            <p class="align-center  ps-1 pe-1 fs-5 mb-0 text-center">
                                                                 &nbsp;
                                                       ...
                                                       <div class="card-body">
                                                            ...
                                                            if ($name) { // If name exists in the database
                                                                 ?>
                                                                 <a href="editcontractorworkman.php?token=<?php echo $row1['token_no'] ?>"
                                                                      class="btn btn-primary form-control"><i
                                                                           class="fa-solid fa-edit"></i>Edit</a>
                                                            <?php } else { // If name doesn't exist in the database ?>
                                                                 <a href="addcontractorworkman.php?token=<?php echo $row1['token_no'] ?>"
                                                                      class="btn btn-primary form-control"><i
     ...
     <script>
          ...
          document.getElementById('navbar-title').innerHTML = "Contractor Workman <i class='fa-solid fa-users'></i>";
     </script>
     ...
     <script>
          ...
          document.getElementById('sidebar-toggle').addEventListener('click', function () {
               ...
               document.querySelector('.wrapper').classList.toggle('sidebar-closed');
                   ...
                   <script>
        document.getElementById('contractor_workmanForm').addEventListener('submit', function (e) {
            var inputField = document.getElementById('contractor_workmanInput');
