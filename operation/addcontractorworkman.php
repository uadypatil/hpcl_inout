    ...
    $firm_name = $_POST['firm_name'];
     ...
     if(mysqli_num_rows($resa) > 0) {
        ...
        //  </script>';
         ...
         $sqlof = "INSERT INTO `uni_aadhar` (`aadhar_no`, `role`) VALUES ('$aadhar_no', 'CONW')";
   ...
   <div class="card border-0 shadow mt-4">
    <div class="card-body m-4">
            ...
            <form method="post" id="myform" action="#" enctype="multipart/form-data">
                <div class="row mt-2">
                    <div class="col-md-12 mb-4">
                        ...
                        <input type="text" name="token_no" id="token_no"  value="<?php echo $token ?>"class="form-control" placeholder="Enter Token Number" readonly>
                ...
                <div class="row">
                    <div class="col-md-12 mb-4">
                        ...
                        <input type="text" name="full_name" id="full_name" oninput="this.value=this.value.replace(/[^a-z\sA-Z]/g,'');ws(this.id);" class="form-control" placeholder="Enter Full Name" required>
                ...
                <div class="row">
                    <div class="col-md-12 mb-4">
                        ...
                        <input type="text" name="mobile_no" id="mobile_no" oninput="this.value=this.value.replace(/[^0-9]/g,'')" size="10" minlength="10" maxlength="10" class="form-control" placeholder="Enter Mobile Number" required>
                ...
                <div class="row">
                    <div class="col-md-12 mb-4">
                        ...
                        <textarea name="address" id="address" class="form-control" oninput="this.value=this.value.replace(/[^a-z\sA-Z0-9,.-]/g,'');ws(this.id);" rows="3" placeholder="Enter Address" required></textarea>
     ...
     <script>
          ...
          document.getElementById("navbar-title").innerHTML = "Add Contractor Workman Form <i class='fa-solid fa-users'></i>";
     </script>
