...
$sql = "SELECT * from contractor where token_no=$token";
...
if (isset($_POST['update'])) {
    ...
    if(mysqli_num_rows($resa) > 0){
        ...
        $table=$rowa['role'];
        if ($table == 'CON') {
       $sqlo = "SELECT * FROM contractor where aadhar_no= '$aadhar_no'";
       ...
       if ( mysqli_num_rows($reso) > 0) {
        ...
        $sql = "UPDATE contractor SET aadhar_no='$aadhar_no',full_name='$full_name',mobile_no='$mobile_no',address='$address' WHERE token_no='$token'";
        $res = mysqli_query($connection, $sql);
...
if (isset($_POST['drop'])) {
    ...
    $sql2 = "UPDATE `contractor` SET `aadhar_no`=NULL,`full_name`=NULL,`mobile_no`=NULL,`address`=NULL ,`firm_name`=NULL,`qr_code`=NULL, `qr_path`=NULL,`restricted` = '0' WHERE `token_no`='$token'";
...
function isQrGenerated($token_no)
{
    ...
    $sql = "SELECT `qr_code` FROM `contractor` WHERE `token_no` = $token_no";
    global $connection;
    $res = mysqli_query($connection, $sql);
    if ($res) {
...
{
    global $connection;
    $sql = "SELECT `id`, `token_no`, `working_as` FROM `contractor` WHERE `token_no` = '$token_no'";
    $res = mysqli_query($connection, $sql);
    $working_as = "";
    ...
    $sqlUpdate = "UPDATE `contractor` SET `qr_code`='$finalQr' ,`qr_path`='$filename'  WHERE `token_no` = '$token_no'";
...
{
    header("Location: contractoricard.php?token=$token_no");
}
...
<body>
    ...
    <div class="wrapper d-flex">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="aadhar_no" class="form-control" placeholder="Enter Aadhar Number"
                                            ...
                                            value="<?php echo $row['aadhar_no'] ?>" required>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="full_name" id="full_name" placeholder="Enter Full Name"
                                            ...
                                            class="form-control" value="<?php echo $row['full_name'] ?>" required>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="firm_name" id="firm_name" class="form-control" placeholder="Enter Firm Name"
                                            oninput="this.value=this.value.replace(/[^a-z\sA-Z0-9]/g,'');ws(this.id);"
                                            value="<?php echo $row['firm_name'] ?>">
                            ...
                            <div class="d-grid gap-2 d-sm-block">
                                <div>
                                    <button class="btn btn-primary" id="update" name="update"><i
                                            class="fa-solid fa-user-pen"></i></i> Update</button>
                                    <!-- <button class="btn btn-secondary" name="id_card" id="idcard-btn"><i class="fa-solid fa-id-card"></i>  Id Card</button> -->
                                    ...
                                    <button class="btn btn-danger" name="drop" id="drop"
                                        ...
                                        Drop</button>
                                    <!-- <button class="btn btn-danger" id="drop" name="drop"><i class="fa-solid fa-user-xmark"></i> -->
        ...
        <script>
            ...
            document.getElementById("navbar-title").innerHTML = "Edit Contractor Form <i class='fa-solid fa-users'></i>";
