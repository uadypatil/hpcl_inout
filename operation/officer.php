...
if (isset($_POST['submit'])) {
     ...
     for ($x = $token_no + 1; $x <= $total; $x++) {
          $sql2 = "INSERT INTO `officer`(`token_no`) VALUES ('$x')";
...
<body>
                         ...
                         <div id="officerForm" class="row">
                              ...
                              <div class="col-lg-5">
                                   <input type="text" name="addtoken"
                                        ...
                                        maxlength="2" id="officerInput" class="form-control">
                                   <!-- addcard -->
                              </div>
                              <!-- change button -->
                              <div class="col-lg-7">
     ...
     <script>
          ...
          document.getElementById("navbar-title").innerHTML = "Officer <i class='fa-solid fa-users'></i>";
     </script>
