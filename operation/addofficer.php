...
if(isset($_POST['submit'])){
    ...
    if(mysqli_num_rows($resa) > 0) {
        ...
        $sqlof = "INSERT INTO `uni_aadhar` (`aadhar_no`, `role`) VALUES ('$aadhar_no', 'OFC')";
         $resof = mysqli_query($connection, $sqlof); 

        $sql = "UPDATE `officer` SET `aadhar_no`='$aadhar_no',`full_name`='$full_name',`mobile_no`='$mobile_no',`address`='$address' WHERE `token_no` = '$token'";
   ...
   <div class="card border-0 shadow mt-4">
    <div class="card-body m-4">
            ...
            <form method="post" action="#" id="myform" enctype="multipart/form-data">
                <div class="row mt-2">
                    <div class="col-md-12 mb-4">
                        ...
                        <input type="text" name="token_no" id="token_no" class="form-control" placeholder="Enter Token Number" value="<?php echo $token;?>" readonly>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 mb-4">
                        ...
                        <input type="text" name="full_name" id="full_name" oninput="this.value=this.value.replace(/[^a-z\sA-Z]/g,'');
                        ws(this.id);" class="form-control" value="<?php ?>" placeholder="Enter Full Name" required>
                ...
                <div class="row">
                    <div class="col-md-12 mb-4">
                        ...
                        <!-- <input type="text" name="address" id="address" class="form-control" rows="3" value="<?php  ?>" placeholder="Enter Address" required>
     ...
     <script>
          ...
          document.getElementById('navbar-title').innerHTML = "Add Officer Form";
     </script>
