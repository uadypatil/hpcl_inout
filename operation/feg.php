...
if (isset($_POST['submit'])) {
     ...
     for ($x = $token_no + 1; $x <= $total; $x++) {
          $sql2 = "INSERT INTO feg(token_no) VALUES ('$x')";
...
<body>
          ...
          <div class="container-fluid">
               ...
               <div class="container-fluid">
                    ...
                    <div class="counter-div">
                         ...
                         <form action="<?php // htmlspecialchars($_Server['PHP_SELF']); ?>" id="fegForm" method="post">
                              <div class="row">
                                   <div class="col-lg-5">
                                        <label for="" class="fs-3">FEG Cylinder Count</label>
                                   </div>
                                   <div class="col-lg-7">
                              ...
                              <div id="officerForm" class="row">
                                   ...
                                   <div class="col-lg-5">
                                        <input type="text" name="addtoken"
                                             oninput="this.value=this.value.replace(/[^0-9]/g,'')" size="2"
                                             minlength="2" maxlength="2" id="fegInput" class="form-control">
                                        <!-- addcard -->
                                   </div>
                                   <!-- change button -->
                                   <div class="col-lg-7">
                                             ...
                                             <div class="card text-center" id="<?php echo $uniqueCardId ?>">
                                                  ...
                                                  <div class="card-body">
                                                       ...
                                                       if ($name) { // If name exists in the database
                                                            ?>
                                                            <a href="editfeg.php?token=<?php echo $row1['token_no'] ?>"
                                                                 class="btn btn-primary form-control">
                                                                 <i class="fa-solid fa-edit"></i>Edit</a>
                                                       <?php } else { // If name doesn't exist in the database ?>
                                                            <a href="addfeg.php?token=<?php echo $row1['token_no'] ?>"
                                                                 class="btn btn-primary form-control">
     ...
     <!-- dinamic card generation code script starts here -->
     <script>
          document.getElementById('officerForm').addEventListener('submit', function (event) {
               event.preventDefault();
               const numOfficers = document.getElementById('officerInput').value;
               if (!numOfficers || isNaN(numOfficers)) {
                    alert('Please enter a valid number of officers.');
                    return;
               }
               generateCards(parseInt(numOfficers, 10));
          });

          function generateCards(numOfficers) {
               ...
               for (let i = 0; i < numOfficers; i++) {
                    ...
                    cardDiv.innerHTML = `
                              ...
                              <div class="card-body">
                              <h5 class="card-title">Officer ${i + 1}</h5>
     ...
     <!-- dinamic card generation code script ends here -->

     <!-- giving title to document and navbar -->
     <script>
          document.getElementById('page-title').innerHTML = "HPCL INOUT | FEG";
          document.getElementById('navbar-title').innerHTML = "FEG <i class='fa-solid fa-users'></i>";
     </script>
     ...
     <script>
          ...
          document.getElementById('sidebar-toggle').addEventListener('click', function () {
               ...
               document.querySelector('.wrapper').classList.toggle('sidebar-closed');
                  ...
                  <script>
        document.getElementById('fegForm').addEventListener('submit', function (e) {
            var inputField = document.getElementById('fegInput');
