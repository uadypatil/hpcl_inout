...
$resu=mysqli_query($connection,$sqlu);
    ...
    if (!empty($rowu) && ($rowu['role'] == 'OFC' || $rowu['role'] == 'EMP' || $rowu['role'] == 'CON' || $rowu['role'] == 'CONW' || $rowu['role'] == 'GAT' || $rowu['role'] == 'TAT' || $rowu['role'] == 'SEC' || $rowu['role'] == 'FEG')) {
        // Your code here
    ...
    } else if (!empty($rowu) && ($rowu['role'] == 'PT' || $rowu['role'] == 'BK' || $rowu['role'] == 'TR' )){
    ...
    }else if (!empty($rowu) && ($rowu['role'] == 'PW' || $rowu['role'] == 'AMC')){
