...
<!-- <div class="row">
          <div class="col-lg-12">
               <div class="">
                    <p class="text-center fs-2 fw-bold border-bottom">
                         <spans>
                              <?php // echo $maintable ?> </span>
                    </p>
               </div>
          </div>
     </div> -->
<div class="container-fluid">
     <div class="bg-secondary d-flex justify-content-between mb-3 rounded">
          ...
          <div class="title-div">
               <p class="text-center align-center mt-4">
                    <span class="label label-default fs-4 bg-danger text-capitalize">
     ...
     <!-- <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            <a class="navbar-brand" href="#">
                <img src="https://manasvi.tech/demo/assest/img/logos/hpcl_logo.png" alt="Logo" width="200" height="30">
            </a>
            <div class="mx-auto">
                <span class="navbar-text h5">My Application</span>
            </div>
            <div id="time" class="navbar-text ml-auto">
            </div>
        </div>
    </nav> -->
     ...
     <!-- container-fluid -->
     <div class="row mb-2">
          <form action="<?php htmlspecialchars($_SERVER['PHP_SELF']); ?>" id="driverform" method="post" class="col-lg-12 mb-3">
               <input type="text" name="qr-field" id="qr-field" placeholder="Your QR code" class="form-control"
                    oninput="this.form.submit()"> <!-- this.form.submit() -->
          </form>
     </div>
     <!-- <script>
          function submitform(){
          ...
          <div class="col-12">
               <div id="error-box" class="alert-box alert alert-danger alert-dismissible fade in">
                    ...
                    <button class="close" data-dismiss="alert" aria-label="close"
                         onclick="window.location.replace('<?php echo $filename; ?>')">&times;</button>
                    <!-- </a> -->
