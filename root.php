...
<?php
// $root_dir = "C:/xampp/htdocs/hpcl_in_out/";          // root location for main folder 
//$root_dir = "C:/xampp/htdocs/eaglebyte/hpcl_in_out/hpcl_in_out/";          // root location for main folder 
// $local_dir = "http://localhost/hpcl_in_out/";         // localhost directory for main folder
// $root_dir = "https://3f86-49-36-43-211.ngrok-free.app/hpcl_in_out/";  

// root location for main folder 
// $local_dir = "http://localhost/hpcl_in_out/";         // localhost directory for main folder
// $local_dir = "https://2693-49-36-41-85.ngrok-free.app/eaglebyte/hpcl_in_out/hpcl_in_out/";         // localhost directory for main folder

// $root_dir = "C:/xampp/htdocs/eaglebyte/hpcl_in_out/hpcl_in_out/"; // root location for main folder 
//$local_dir = "http://localhost/eaglebyte/hpcl_in_out/hpcl_in_out/"; // localhost directory for main folder
