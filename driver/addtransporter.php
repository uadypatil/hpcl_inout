...
if (isset($_POST['submit'])) {
    ...
    //   </script>';
        ...
        $sqlof = "INSERT INTO `uni_aadhar` (`aadhar_no`, `role`) VALUES ('$aadhar_no', 'TR')";
        ...
        $sql = "UPDATE `transporter` SET `aadhar_no`='$aadhar_no',`full_name`='$full_name',`mobile_no`='$mobile_no',`address`='$address',`firm_name`='$firm_name',`truck_no`='$truck_no' WHERE `token_no` = '$token'";
...
<body>
    ...
    <div class="wrapper d-flex">
        ...
        <div class="container-fluid">
            ...
            <div class="container-fluid">
                <!-- container-fluid -->
                <!-- <div id="error-box" class="alert alert-danger" style="display: none;">Already Exist </div> -->
                        ...
                        <form method="post" id="myform" action="#" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-4">
                                    ...
                                    <input type="text" name="truck_no" id="truck_no" placeholder="Enter Truck No"
    ...
    <script>
        ...
        document.getElementById("navbar-title").innerHTML = "Add Transporter Form <i class='fa-solid fa-users'></i>";
    </script>
