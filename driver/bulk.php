...
if (isset($_POST['submit'])) {
     ...
     for ($x = $token_no + 1; $x <= $total; $x++) {
          $sql2 = "INSERT INTO `bulk`(`token_no`) VALUES ('$x')";
...
<body>
          ...
          <div class="container-fluid">
               ...
               <div class="container-fluid">
                    ...
                    <form action="#" id="bulkForm" method="post">
                         <div class="row">
                              <div class="col-lg-3">
                                   <label class="fs-3" for="">Bulk Cylinder Count</label>
                              </div>
                              <div class="col-lg-9">
                         ...
                         <div id="officerForm" class="row">
                              ...
                              <div class="col-lg-5">
                                   ...
                                   maxlength="2" id="bulkInput" class="form-control">
                                   <!-- addcard -->
                              </div>
                              <!-- change button -->
                              <div class="col-lg-7">
                    ...
                    <?php while ($row1 = mysqli_fetch_assoc($res1)) {
                         ...
                         <div class="col-sm-6 col-md-3 col-lg-2 mb-5">
                              <div class="card text-center" id="<?php echo $uniqueCardId ?>">
                                   <div class="error-box w-100 d-block text-start">
                                        <p class="align-center mb-0 ps-1 pe-1 fs-5 text-center mb-0">
                                             &nbsp;
                                   ...
                                   <div style="position: relative;">
                                        ...
                                        <img src="<?php echo $images_dir . 'bluecylinder.png'; ?>" class="card-img-top"
                                             alt="...">
                                   </div>
     ...
     <script>
          document.getElementById('page-title').innerHTML = "HPCL INOUT | Bulk";
          document.getElementById("navbar-title").innerHTML = "Bulk <i class='fa-solid fa-users'></i>";
     </script>
     ...
     <script>
          document.getElementById('bulkForm').addEventListener('submit', function (e) {
               var inputField = document.getElementById('bulkInput');
