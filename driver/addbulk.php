...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_num_rows($resa) > 0) {
        ...
        $sqlof = "INSERT INTO `uni_aadhar` (`aadhar_no`, `role`) VALUES ('$aadhar_no', 'BK')";
        ...
        $sql = "UPDATE `bulk` SET `aadhar_no`='$aadhar_no',`full_name`='$full_name',`mobile_no`='$mobile_no',`address`='$address',`firm_name`='$firm_name',`truck_no`='$truck_no' WHERE `token_no` = '$token'";
...
<body>
                    ...
                    <div class="card-body m-4">
                        ...
                        <form method="post" id="myform" action="#" enctype="multipart/form-data">
                            ...
                            <div class="d-grid gap-2 d-sm-block">
                                <div>
                                    <button class="btn btn-primary" name="submit"><i
    ...
    <script>
        ...
        document.getElementById("navbar-title").innerHTML = "Add Bulk Form <i class='fa-solid fa-users'></i>";
    </script>
