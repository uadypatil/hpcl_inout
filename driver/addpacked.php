...
if (isset($_POST['submit'])) {
    ...
    //  echo "ooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo
//  ooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo
//  ooooooooooooooooooooooooooooooooooooooooooooo";die;
    ...
    //   </script>';
        ...
        $sqlof = "INSERT INTO `uni_aadhar` (`aadhar_no`, `role`) VALUES ('$aadhar_no', 'PT')";
        ...
        $sql = "UPDATE `packed` SET `aadhar_no`='$aadhar_no',`full_name`='$full_name',`mobile_no`='$mobile_no',`address`='$address',`firm_name`='$firm_name',`truck_no`='$truck_no' WHERE `token_no` = '$token'";
...
<body>
                        ...
                        <form method="post" action="#" id="myform" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-4">
                                    ...
                                    <input type="text" name="full_name" id="full_name"
                                        oninput="this.value=this.value.replace(/[^a-z\sA-Z]/g,'');ws(this.id);" id="full_name"
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-4">
                                    ...
                                    <input type="text" name="firm_name" id="firm_name" oninput="this.value=this.value.replace(/[^a-z\sA-Z]/g,'');ws(this.id);" class="form-control"
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-4">
                                    ...
                                    <input type="text" name="truck_no"
                                        oninput="this.value=this.value.replace(/[^a-zA-Z0-9\s]/g, '');ws(this.id);" id="truck_no"
                                        class="form-control" placeholder="Enter Truck No" required>
    ...
    <script>
        ...
        document.getElementById("navbar-title").innerHTML = "Add Packed Form <i class='fa-solid fa-users'></i>";
    </script>
                    ...
                    fetch('../autofill.php?aadhar_no=' + aadhar_no)
                        ...
                        .then(data => {
                            ...
                            if (data.message == "data found") {
                                ...
                                document.getElementById('truck_no').setAttribute('readonly', true);
                            }
                            else{
                                ...
                                document.getElementById('truck_no').removeAttribute('readonly');
                                ...
                                // document.getElementById('firm_name').value = firm;
                                // document.getElementById('truck_no').value = truck;
