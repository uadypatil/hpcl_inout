...
if (isset($_POST['submit'])) {
    ...
    for ($x = $token_no + 1; $x <= $total; $x++) {
        $sql2 = "INSERT INTO `transporter`(`token_no`) VALUES ('$x')";
...
<body>
     ...
     <div class="wrapper d-flex overall-body">
          ...
          <div class="container-fluid">
               ...
               <div class="container-fluid">
                    ...
                    <form action="#" id="transporterForm" method="post">
                              <div class="row">
                                   <div class="col-lg-4">
                                        <label class="fs-3" for="">Transporter Cylinder Count</label>
                                   </div>
                                   <div class="col-lg-8">
                              ...
                              <div id="officerForm" class="row">
                                   ...
                                   <div class="col-lg-5">
                                        ...
                                        maxlength="2" id="transporterInput" class="form-control">
                                        <!-- addcard -->
                                   </div>
                                   <!-- change button -->
                                   <div class="col-lg-7">
         ...
         $sqla = "SELECT id FROM maingate WHERE qr_code = '" . $row1['qr_code'] . "' AND status = '1' AND date = CURDATE()";
          ...
          ?>
            ...
            <div class="card-body pt-0">
              <h5 style="height: 30px; overflow: hidden;" class="card-title">&nbsp;
              ...
              ?>
              <a href="edittransporter.php?token=<?php echo $row1['token_no'] ?>" class="btn btn-primary form-control"><i
                  class="fa-solid fa-edit"></i>Edit</a>
              <?php } else { // If name doesn't exist in the database ?>
              <a href="addtransporter.php?token=<?php echo $row1['token_no'] ?>" class="btn btn-primary form-control"><i
     ...
     <script>
          ...
          document.getElementById("navbar-title").innerHTML = "Transporter <i class='fa-solid fa-users'></i>";
     </script>
     ...
     <script>
          ...
          <script>
        document.getElementById('transporterForm').addEventListener('submit', function (e) {
            var inputField = document.getElementById('transporterInput');
