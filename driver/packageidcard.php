...
if (isset($_GET['token'])) {
     ...
     $filename = "";
     $qr_code = "";
     $sql_icard = "SELECT `full_name`, `mobile_no`, `address`,`working_as` ,`qr_code`, `qr_path` FROM `packed` WHERE `token_no` = '$token'";
     ...
     if ($res_icard) {
          ...
          <body>
                              ...
                              <div class="content" id="contentToPrint">
                                   ...
                                   <main>
                                        <div class="qr-text-div row text-center mb-4" style="background-color: red;" id="nav1">
                                             <p class="fs-1 fw-bold text-light text-uppercase"><span id="qr-text">OPR -
                                                       <?php echo $qr_code; ?>
               ...
               <script>
                    ...
                    document.getElementById('navbar-title').innerHTML = "Packed I-Card";               
               </script>
