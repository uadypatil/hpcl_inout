...
if (isset($_POST['submit'])) {
    ...
    for ($x = $token_no + 1; $x <= $total; $x++) {
        $sql2 = "INSERT INTO `packed`(`token_no`) VALUES ('$x')";
...
<body>
     ...
     <div class="wrapper d-flex overall-body">
          ...
          <div class="container-fluid">
               ...
               <div class="container-fluid">
                    ...
                    <form action="#" id="packedForm" method="post">
                              <div class="row">
                                   <div class="col-lg-4">
                                        <label class="fs-3" for="">Packed Cylinder Count</label>
                                   </div>
                                   <div class="col-lg-8">
                              ...
                              <div id="officerForm" class="row">
                                   <!-- input field -->
                                   <div class="col-lg-5">
                                        <input type="text" name="addtoken" oninput="this.value=this.value.replace(/[^0-9]/g,'')" size="2" minlength="2"
                                        maxlength="2" id="packedInput" class="form-control">
                                        <!-- addcard -->
                                   </div>
                                   <!-- change button -->
                                   <div class="col-lg-7">
        ...
        <div class="col-sm-6 col-md-3 col-lg-2 mb-5">
          <div class="card text-center" id="<?php echo $uniqueCardId ?>">
            <div class="error-box w-100 d-block text-start">
            <p class="align-center  ps-1 pe-1 fs-5 text-center mb-0">
     &nbsp;
     <span class="bg-danger text-light">
          ...
          ?>
            ...
            <div style="position: relative;">
              ...
              <img
                src="<?php echo $images_dir . 'bluecylinder.png'; ?>"
                class="card-img-top" alt="...">
            </div>
            <div class="card-body pt-0">
              <h5 style="height: 30px; overflow: hidden;" class="card-title" data-rows="3">
              ...
              ?>
              <a href="editpacked.php?token=<?php echo $row1['token_no'] ?>" class="btn btn-primary form-control">
              <i class="fa-solid fa-edit"></i>Edit</a>
              <?php } else { // If name doesn't exist in the database ?>
              <a href="addpacked.php?token=<?php echo $row1['token_no'] ?>" class="btn btn-primary form-control">
     ...
     <script>
          document.getElementById('page-title').innerHTML = "HPCL INOUT | Packed";
          document.getElementById("navbar-title").innerHTML = "Packed <i class='fa-solid fa-users'></i>";
     </script>
     ...
     <script>
        document.getElementById('packedForm').addEventListener('submit', function (e) {
            var inputField = document.getElementById('packedInput');
