...
if (isset($_POST['submit'])) {
     ...
     for ($x = $token_no + 1; $x <= $total; $x++) {
          $sql2 = "INSERT INTO amc(token_no) VALUES ('$x')";
...
<body>
               ...
               <div class="container-fluid">
                    ...
                    <div class="container-fluid">
                         ...
                         <div class="counter-div">
                              ...
                              <form action="<?php // htmlspecialchars($_Server['PHP_SELF']); ?>" method="post" id="amcform">
                                   <div class="row">
                                        <div class="col-lg-3 fs-2">
                                             <label for="">AMC Cylinder Count</label>
                                        </div>
                                        <div class="col-lg-9">
                                   ...
                                   <div id="officerForm" class="row">
                                        <!-- input field -->
                                        <div class="col-lg-5">
                                             <input type="text" name="addtoken" oninput="this.value=this.value.replace(/[^0-9]/g,'')" size="2" minlength="2" maxlength="2" id="amcinput" class="form-control">
                                             <!-- addcard -->
                                        </div>
                                        <!-- change button -->
                                        <div class="col-lg-7">
     ...
     <script>
          ...
          document.getElementById('navbar-title').innerHTML = "AMC <i class='fa-solid fa-users'></i>";
     </script>
     ...
     <script>
          document.getElementById('amcform').addEventListener('submit', function (e) {
               var inputField = document.getElementById('amcinput');
