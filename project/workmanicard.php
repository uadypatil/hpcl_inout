...
if (isset($_GET['token'])) {
     ...
     $filename = "";
     $qr_code = "";
     $sql_icard = "SELECT `full_name`, `mobile_no`, `address`,`working_as` ,`qr_code`, `qr_path` FROM `workman` WHERE `token_no` = '$token'";
     ...
     if ($res_icard) {
          ...
          <body>
                              ...
                              <div class="content" id="contentToPrint">
                                   ...
                                   <main>
                                        <div class="qr-text-div row text-center mb-4" style="background-color: red;" id="nav1">
                                             <p class="fs-1 fw-bold text-light text-uppercase">OPR-<span id="qr-text">
                                                       <?php echo $qr_code; ?>
                                        ...
                                        <div class="row">
                                             <div class="col-lg-8">
                                                  <ul class="fs-3 fw-bold text-start text-body-tertiary"
                                                       ...
                                                       <li><span>Mobile Number: </span><span>
                                                                 <?php echo $mobile_no; ?>
                                                            </span></li>
               ...
               <script>
                    ...
                    document.getElementById('navbar-title').innerHTML = "Workman I-card";               
               </script>
