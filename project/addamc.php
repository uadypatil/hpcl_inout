...
if (isset($_POST['submit'])) {
    ...
    $sqla = "SELECT * FROM `uni_aadhar` where `aadhar_no`= '$aadhar_no'";
     ...
     if(mysqli_num_rows($resa) > 0) {
        ...
        $sqlof = "INSERT INTO `uni_aadhar` (`aadhar_no`, `role`) VALUES ('$aadhar_no', 'AMC')";
            ...
            <div class="container-fluid">
                ...
                <div class="card border-0 shadow mt-4">
                    <div class="card-body m-4">
                       ...
                       <textarea name="address" id="address" class="form-control" rows="3" value="<?php  ?>" placeholder="Enter Address" oninput="this.value=this.value.replace(/[^a-z\sA-Z0-9,.-]/g,'');ws(this.id);"      required></textarea>
...
function ws(name) { 
    ...
    <script>
        ...
        document.getElementById("navbar-title").innerHTML = "AMC Form <i class='fa-solid fa-users'></i>";
