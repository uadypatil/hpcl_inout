...
if (isset($_POST['submit'])) {
    ...
    $sqla = "SELECT * FROM `uni_aadhar` where `aadhar_no`= '$aadhar_no'";
     ...
     if(mysqli_num_rows($resa) > 0) {
        ...
        $sqlof = "INSERT INTO `uni_aadhar` (`aadhar_no`, `role`) VALUES ('$aadhar_no', 'PW')";
    ...
    if ($res) {
        ...
        // Ensure no further code is executed after the script
            ...
            <div class="container-fluid">
                ...
                <div class="card border-0 shadow mt-4">
                    <div class="card-body m-4">
                        ...
                        <input type="text" name="aadhar_no" id="aadhar_no" class="form-control" oninput="this.value=this.value.replace(/[^0-9]/g,'');checkadhar();" size="12" minlength="12" maxlength="12" method="get" placeholder="Enter Aadhar Number" required>
                        ...
                        <input type="text" name="full_name" id="full_name" oninput="this.value=this.value.replace(/[^a-z\sA-Z]/g,'');ws(this.id);" class="form-control" value="<?php ?>" placeholder="Enter Full Name" required>
                        ...
                        value="<?php ?>" placeholder="Enter Mobile Number" required>
                        ...
                        <textarea name="address" id="address" class="form-control" oninput="this.value=this.value.replace(/[^a-z\sA-Z0-9,.-]/g,'');ws(this.id);"   rows="3" value="<?php  ?>" placeholder="Enter Address" required></textarea>
                        <span id="addrerror" style="color: red;"></span>
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-4">
                                    ...
                                    <input type="text" name="firm_name" id="firm_name" class="form-control" required oninput="this.value=this.value.replace(/[^a-z\sA-Z]/g,'');ws(this.id);checkfirm();"
                            ...
                            <div class="d-grid gap-2 d-sm-block">
                                <div>
                                    ...
                                    <!-- <button class="btn btn-secondary" name="id_card" id="submit"><i
                                            class="fa-solid fa-id-card"></i> Id Card</button> -->
...
function ws(name) { 
    ...
    <script>
        ...
        document.getElementById("navbar-title").innerHTML = "Workman Form <i class='fa-solid fa-users'></i>";
