...
// http://phpqr_code.sourceforge.net/
// https://sourceforge.net/projects/phpqr_code/
//
...
// http://www.denso-wave.com/qr_code/index-e.html
// ---------------------------------------------------------
//
// Author: Nicola Asuni
//
 ...
 *
 * This class is derived from "PHP QR Code encoder" by Dominik Dzienia (http://phpqr_code.sourceforge.net/) based on "libqrencode C library 3.1.1." by Kentaro Fukuchi (http://megaui.net/fukuchi/works/qrencode/index.en.html), contains Reed-Solomon code written by Phil Karn, KA9Q. QR Code is registered trademark of DENSO WAVE INCORPORATED (http://www.denso-wave.com/qr_code/index-e.html).
...
if (!defined('qr_codeDEFS')) {
	...
	// Encoding modes (characters which can be encoded in qr_code)
	...
	/**
	 * Encoding mode numeric (0-9). 3 characters are encoded to 10bit length. In theory, 7089 characters or less can be stored in a qr_code.
	 */
	define('QR_MODE_NM', 0);

	/**
	 * Encoding mode alphanumeric (0-9A-Z $%*+-./:) 45characters. 2 characters are encoded to 11bit length. In theory, 4296 characters or less can be stored in a qr_code.
	 */
	define('QR_MODE_AN', 1);

	/**
	 * Encoding mode 8bit byte data. In theory, 2953 characters or less can be stored in a qr_code.
	 */
	define('QR_MODE_8B', 2);

	/**
	 * Encoding mode KANJI. A KANJI character (multibyte character) is encoded to 13bit length. In theory, 1817 characters or less can be stored in a qr_code.
	 */
	define('QR_MODE_KJ', 3);
	...
	// qr_code has a function of an error correcting for miss reading that white is black.
	...
	// Version. Size of qr_code is defined as version.
...
if (!class_exists('qr_code', false)) {
	...
	class qr_code {
		...
		/**
		 * @var QR code version. Size of qr_code is defined as version. Version is from 1 to 40. Version 1 is 21*21 matrix. And 4 modules increases whenever 1 version increases. So version 40 is 177*177 matrix.
		 * @access protected
		 */
		protected $version = 0;
		 ...
		 * Creates a qr_code object
		 * @param string $code code to represent using qr_code
